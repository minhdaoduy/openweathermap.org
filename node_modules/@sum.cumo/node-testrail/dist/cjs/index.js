...
var transformData$1 = function transformData(data, headers, fns) {
  /*eslint no-param-reassign:0*/
  utils$c.forEach(fns, function transform(fn) {
...
var URL = url$1.URL;
var http$2 = require$$1__default$2['default'];
...
utils$5.forEach(['post', 'put', 'patch'], function forEachMethodWithData(method) {
  defaults$2.headers[method] = utils$5.merge(DEFAULT_CONTENT_TYPE);
});
...
var _default = fs__default['default'];

var originalFs$1 = _default;
...
var fs$2 = fileSystem.require(),
    pth$2 = require$$1__default$3['default'];

fs$2.existsSync = fs$2.existsSync || pth$2.existsSync;
    ...
    function findSync(/*String*/dir, /*RegExp*/pattern, /*Boolean*/recoursive) {
        ...
        fs$2.readdirSync(dir).forEach(function(file) {
            ...
            if (!pattern || pattern.test(path)) {
                files.push(pth$2.normalize(path) + (fs$2.statSync(path).isDirectory() ? PATH_SEPARATOR : ""));
            }
...
var fs$1 = fileSystem.require(),
    pth$1 = require$$1__default$3['default'];
...
const pth = require$$1__default$3['default'];
...
var MAX_ARCHIVE_SIZE = 268435456;
function convertToBase64(str) {
  // create a buffer
  var buff = Buffer.from(str, 'utf-8'); // decode buffer as Base64
...
function getAllFiles(dirPath, arrayOfFiles) {
  ...
  files.forEach(function (file) {
    if (fs__default['default'].statSync(dirPath + "/" + file).isDirectory()) {
      // eslint-disable-next-line no-param-reassign
      arrayOfFiles = getAllFiles(dirPath + "/" + file, arrayOfFiles);
    } else {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      arrayOfFiles.push(require$$1__default$3['default'].join(dirPath, file));
    }
  });
  return arrayOfFiles;
}
function getTotalSize(directoryPath) {
  var arrayOfFiles = getAllFiles(directoryPath);
  var totalSize = 0;
  arrayOfFiles.forEach(function (filePath) {
    totalSize += fs__default['default'].statSync(filePath).size;
  });
  return totalSize;
}
function createArchivesFor(assets, assetsArchiveName) {
  var groupedAssets = [];
  var currentGroupSize = 0;
  assets.reduce(function (group, asset) {
    var latestGroupIndex = group.length > 0 ? group.length - 1 : 0;

    var _asset$split = asset.split(':'),
        source = _asset$split[0]; // Skip source if it does not exist


    if (fs__default['default'].existsSync(source)) {
      var fileSize = getTotalSize(source);
  ...
  var archives = groupedAssets.map(function (assetsInGroup, index) {
    var archive = new admZip();
    assetsInGroup.forEach(function (attachment) {
      var _attachment$split = attachment.split(':'),
          source = _attachment$split[0],
          target = _attachment$split[1];

      if (fs__default['default'].existsSync(source)) {
        archive.addLocalFolder(source, target || '');
      }
    });
    var name = assetsArchiveName + ".zip";
...
var API_ROUTE = '/index.php?/api/v2/';
var DEFAULT_HEADERS = {
  'Content-Type': 'application/json'
};

var TestRailConnector = /*#__PURE__*/function () {
  function TestRailConnector(host, user, password) {
    this.host = host;
    this.user = user;
  ...
  var _proto = TestRailConnector.prototype;

  _proto.getFullHostName = function getFullHostName() {
  ...
  _proto.closeCommand = function closeCommand(command, id) {
    return axios.post(this.getFullHostName() + command + id, null, {
      headers: _extends$1({}, DEFAULT_HEADERS)
    });
  ...
  _proto.getIdCommand = function getIdCommand(command, id) {
    return axios.get(this.getFullHostName() + command + id);
  ...
  _proto.getCommand = function getCommand(command) {
    return axios.get(this.getFullHostName() + command);
  };

  _proto.getExtraCommand = function getExtraCommand(command, id, extra) {
    return axios.get(this.getFullHostName() + command + id + extra);
  };

  _proto.addCommand = function addCommand(command, id, data) {
    return axios.post(this.getFullHostName() + command + id, JSON.stringify(data), {
      headers: _extends$1({}, DEFAULT_HEADERS)
    });
  };

  _proto.addExtraCommand = function addExtraCommand(command, id, extra, data) {
    return axios.post(this.getFullHostName() + command + id + extra, JSON.stringify(data), {
      headers: _extends$1({}, DEFAULT_HEADERS)
    });
  };

  _proto.sendCommand = function sendCommand(projectID, command, data) {
    return axios.post(this.getFullHostName() + command + projectID, JSON.stringify(data), {
      headers: _extends$1({}, DEFAULT_HEADERS)
    });
  };

  _proto.postForm = function postForm(command, id, attachment) {
    var data = new form_data();
    data.append('attachment', fs__default['default'].createReadStream(attachment));
    return axios({
      method: 'post',
      url: this.getFullHostName() + command + id,
      headers: _extends$1({}, data.getHeaders()),
      data: data,
  ...
  _proto.addAttachmentToCase = function addAttachmentToCase(caseId, attachment) {
  ...
  _proto.addAttachmentToPlan = function addAttachmentToPlan(planId, attachment) {
  ...
  _proto.addAttachmentToPlanEntry = function addAttachmentToPlanEntry(planId, entryId, attachment) {
  ...
  _proto.addAttachmentToResult = function addAttachmentToResult(resultId, attachment) {
  ...
  _proto.addAttachmentToRun = function addAttachmentToRun(runId, attachment) {
  ...
  _proto.addAttachmentsToRun =
  /*#__PURE__*/
  function () {
    var _addAttachmentsToRun = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(runId, attachments, assetsArchiveName) {
      var _this = this;
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              if (assetsArchiveName === void 0) {
                assetsArchiveName = null;
              }
              ...
              attachments.forEach(function (attachment) {
                return _this.addAttachmentToRun(runId, attachment);
              });
              return _context2.abrupt("return", null);

            case 4:
              // Create archive for assets and upload it
              archives = createArchivesFor(attachments, assetsArchiveName);
              _context2.next = 7;
              return Promise.all(archives.map( /*#__PURE__*/function () {
                var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(archive) {
                  return regenerator.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return _this.postForm('add_attachment_to_run/', runId, archive);

                        case 2:
                          fs__default['default'].unlinkSync(archive);
    ...
    function addAttachmentsToRun(_x, _x2, _x3) {
      return _addAttachmentsToRun.apply(this, arguments);
    }

    return addAttachmentsToRun;
  }()
  /**
  ...
  _proto.deleteAttachment = function deleteAttachment(attachmentId) {
  ...
  _proto.getCase = function getCase(caseId) {
  ...
  _proto.getCases = function getCases(projectId, suiteId, sectionId) {
    var extra = "&suiteId=" + suiteId;
  ...
  _proto.addCase = function addCase(sectionId, title, typeId, projectId, estimate, milestoneId, refs) {
    var data = {
      title: title,
      type_id: typeId,
  ...
  _proto.updateCase = function updateCase(caseId, title, typeId, projectId, estimate, milestoneId, refs) {
    var data = {
      title: title,
      type_id: typeId,
      project_id: projectId,
  ...
  _proto.deleteCase = function deleteCase(caseId) {
    return this.closeCommand('delete_case/', caseId);
  } // -------- CASE FIELDS -----------------
  ;

  _proto.getCaseFields = function getCaseFields() {
    return this.getCommand('get_case_fields/');
  } // -------- CASE TYPES ------------------
  ;

  _proto.getCaseTypes = function getCaseTypes() {
    return this.getCommand('get_case_types/');
  } // -------- CONFIGURATIONS ------------------
  ;

  _proto.getConfigs = function getConfigs(projectId) {
    return this.getIdCommand('get_configs/', projectId);
  };

  _proto.addConfigGroup = function addConfigGroup(projectId, name) {
    var data = {
      name: name
    };
  ...
  _proto.addConfig = function addConfig(configGroupId, name) {
    var data = {
      name: name
    };
  ...
  _proto.updateConfigGroup = function updateConfigGroup(configGroupId, name) {
    var data = {
      name: name
    };
  ...
  _proto.updateConfig = function updateConfig(configId, name) {
    var data = {
      name: name
    };
  ...
  _proto.deleteConfigGroup = function deleteConfigGroup(configGroupId) {
    return this.closeCommand('delete_config_group/', configGroupId);
  };

  _proto.deleteConfig = function deleteConfig(configId) {
    return this.closeCommand('delete_config/', configId);
  } // -------- MILESTONES ------------------
  ;

  _proto.getMilestone = function getMilestone(milestoneId) {
    return this.getIdCommand('get_milestone/', milestoneId);
  };

  _proto.getMilestones = function getMilestones(projectId) {
    return this.getIdCommand('get_milestones/', projectId);
  };

  _proto.addMilestone = function addMilestone(projectId, name, description, dueOn, parentId, startOn) {
    var data = {
      name: name,
      description: description,
      due_on: dueOn,
  ...
  _proto.updateMilestone = function updateMilestone(milestoneId, name, description, dueOn, startOn, isCompleted, isStarted, parentId) {
    var data = {
      name: name,
      description: description,
      due_on: dueOn,
  ...
  _proto.deleteMilestone = function deleteMilestone(milestoneId) {
    return this.closeCommand('delete_milestone/', milestoneId);
  } // -------- PLANS -----------------------
  ;

  _proto.getPlan = function getPlan(planId) {
    return this.getIdCommand('get_plan/', planId);
  };

  _proto.getPlans = function getPlans(projectId) {
    return this.getIdCommand('get_plans/', projectId);
  };

  _proto.addPlan = function addPlan(projectId, name, description, milestoneId) {
    var data = {
      name: name,
      description: description,
      milestone_id: milestoneId
  ...
  _proto.addPlanEntry = function addPlanEntry(planId, suiteId, name, assignedtoId, includeAll) {
    var data = {
      suite_id: suiteId,
      name: name,
  ...
  _proto.updatePlan = function updatePlan(planId, name, description, milestoneId) {
    var data = {
      name: name,
      description: description,
      milestone_id: milestoneId
  ...
  _proto.updatePlanEntry = function updatePlanEntry(planId, entryId, name, assignedtoId, includeAll) {
    var data = {
      name: name,
      assignedto_id: assignedtoId,
      include_all: includeAll
  ...
  _proto.closePlan = function closePlan(planId) {
    return this.closeCommand('close_plan/', planId);
  };

  _proto.deletePlan = function deletePlan(planId) {
    return this.closeCommand('delete_plan/', planId);
  };

  _proto.deletePlanEntry = function deletePlanEntry(planId, entryId) {
    return this.closeCommand('delete_plan_entry/', planId + "/" + entryId);
  } // -------- PRIORITIES ------------------
  ;

  _proto.getPriorities = function getPriorities() {
    return this.getCommand('get_priorities/');
  } // -------- PROJECTS --------------------
  ;

  _proto.getProject = function getProject(projectId) {
  ...
  _proto.addProject = function addProject(name, announcement, showAnnouncement) {
    var data = {
      name: name,
  ...
  _proto.updateProject = function updateProject(projectId, name, announcement, showAnnouncement, isCompleted) {
    var data = {
      name: name,
      announcement: announcement,
      show_announcement: showAnnouncement,
  ...
  _proto.deleteProject = function deleteProject(projectId) {
    return this.closeCommand('delete_project/', projectId);
  } // -------- RESULTS ---------------------
  ;

  _proto.getResults = function getResults(testId, limit) {
    if (limit == null) {
      return this.getIdCommand('get_results/', testId);
    }

    var extra = "&limit=" + limit;
    return this.getExtraCommand('get_results/', testId, extra);
  };

  _proto.getResultsForCase = function getResultsForCase(runId, caseId, limit) {
    var extra = "/" + caseId;
  ...
  _proto.addResult = function addResult(testId, statusId, comment, version, elapsed, defects, assignedtoId) {
    var data = {
      status_id: statusId,
      comment: comment,
      version: version,
  ...
  _proto.addResults = function addResults(runId, results) {
    return this.addExtraCommand('add_results/', runId, '', results);
  };

  _proto.addResultForCase = function addResultForCase(runId, caseId, statusId, comment, version, elapsed, defects, assignedtoId) {
    var data = {
      status_id: statusId,
      comment: comment,
      version: version,
  ...
  _proto.addResultsForCases = function addResultsForCases(runId, results) {
    return this.addExtraCommand('add_results_for_cases/', runId, '', results);
  } // -------- RESULT FIELDS ---------------------
  ;

  _proto.getResultFields = function getResultFields() {
    return this.getIdCommand('get_result_fields/', '');
  } // -------- RUNS ------------------------
  ;

  _proto.getRun = function getRun(runId) {
    return this.getIdCommand('get_run/', runId);
  };

  _proto.getRuns = function getRuns(projectId, additionalArgs) {
    if (additionalArgs === void 0) {
      additionalArgs = '';
    }

    return this.getIdCommand('get_runs/', projectId + additionalArgs);
  }
  /**
  ...
  _proto.addRun = function addRun(projectID, suiteId, name, description, milestoneId, includeAll, caseIds, refs) {
    var data = {
      suite_id: suiteId,
      name: name,
      description: description,
  ...
  _proto.updateRun = function updateRun(runID, name, description, milestoneId, includeAll, caseIds, refs) {
    var data = {
      name: name,
      description: description,
      milestone_id: milestoneId,
  ...
  _proto.closeRun = function closeRun(runId) {
    return this.closeCommand('close_run/', runId);
  };

  _proto.deleteRun = function deleteRun(runId) {
    return this.closeCommand('delete_run/', runId);
  } // -------- STATUSES --------------------
  ;

  _proto.getStatuses = function getStatuses() {
    return this.getCommand('get_statuses/');
  } // -------- SECTIONS --------------------
  ;

  _proto.getSection = function getSection(sectionId) {
    return this.getIdCommand('get_section/', sectionId);
  };

  _proto.getSections = function getSections(projectId, suiteId) {
    return this.getExtraCommand('get_sections/', projectId, "&suiteId=" + suiteId);
  };

  _proto.addSection = function addSection(projectId, suiteId, parentId, name) {
    var data = {
      suite_id: suiteId,
      parent_id: parentId,
      name: name
  ...
  _proto.updateSection = function updateSection(sectionId, name) {
    var data = {
      name: name
    };
  ...
  _proto.deleteSection = function deleteSection(sectionId) {
    return this.closeCommand('delete_section/', sectionId);
  } // -------- SUITES -----------
  ;

  _proto.getSuite = function getSuite(suiteId) {
    return this.getIdCommand('get_suite/', suiteId);
  };

  _proto.getSuites = function getSuites(projectId) {
    return this.getIdCommand('get_suites/', projectId);
  };

  _proto.addSuite = function addSuite(projectId, name, description) {
    var data = {
      name: name,
      description: description
    };
  ...
  _proto.updateSuite = function updateSuite(suiteId, name, description) {
    var data = {
      name: name,
      description: description
    };
  ...
  _proto.deleteSuite = function deleteSuite(suiteId) {
    return this.closeCommand('delete_suite/', suiteId);
  } // -------- TESTS -----------------------
  ;

  _proto.getTest = function getTest(testId) {
    return this.getIdCommand('get_test/', testId);
  };

  _proto.getTests = function getTests(runId) {
    return this.getIdCommand('get_tests/', runId);
  } // -------- USERS -----------------------
  ;

  _proto.getUser = function getUser(userId) {
    return this.getIdCommand('get_user/', userId);
  };

  _proto.getUserByEmail = function getUserByEmail(email) {
