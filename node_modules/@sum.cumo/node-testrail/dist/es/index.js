...
function getAllFiles(dirPath, arrayOfFiles) {
  ...
  files.forEach(function (file) {
    if (fs$4.statSync(dirPath + "/" + file).isDirectory()) {
      // eslint-disable-next-line no-param-reassign
      arrayOfFiles = getAllFiles(dirPath + "/" + file, arrayOfFiles);
    } else {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      arrayOfFiles.push(require$$1$3.join(dirPath, file));
    }
  });
  return arrayOfFiles;
}
function getTotalSize(directoryPath) {
  ...
  arrayOfFiles.forEach(function (filePath) {
    totalSize += fs$4.statSync(filePath).size;
  });
  return totalSize;
}
...
var TestRailConnector = /*#__PURE__*/function () {
  ...
  _proto.postForm = function postForm(command, id, attachment) {
    ...
    data.append('attachment', fs$4.createReadStream(attachment));
    return axios({
      method: 'post',
